        ...
        <div className="content">
          <div className="back">
            <div className="back-content">
              <div className="w-16 h-16 bg-purple-600/20 rounded-full flex items-center justify-center border border-purple-500/30">
                 <span className="text-2xl font-black text-purple-400">$</span>
              </div>
              <div className="text-center">
                <p className="text-white font-black text-xl">{price}</p>
                <p className="text-purple-400 text-[10px] font-black uppercase tracking-widest mt-1">Precio sugerido</p>
              </div>
              <button className="px-6 py-2 bg-purple-600 text-white font-black rounded-xl text-[10px] uppercase tracking-widest hover:bg-purple-500 transition-colors">
                Ver Detalles
              </button>
            </div>
          </div>
...
const StyledWrapper = styled.div`
  ...
  .content {
    ...
    box-shadow: 0px 0px 20px 1px rgba(168, 85, 247, 0.1);
    border-radius: 2rem;
  }
