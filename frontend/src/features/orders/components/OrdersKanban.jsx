    ...
    <div className="font-outfit space-y-12 animate-in fade-in duration-700">
      ...
      <div className="flex gap-6 md:gap-8 overflow-x-auto pb-10 h-[calc(100vh-280px)] md:h-[calc(100vh-220px)] items-start scrollbar-thin scrollbar-thumb-zinc-800">
        {ORDER_STATUSES.map(status => {
          ...
          return (
            <div key={status.id} className="min-w-[280px] md:min-w-[350px] w-[280px] md:w-[350px] flex-shrink-0 flex flex-col h-full">
                    ...
                    >
                      <div className="flex justify-between items-start mb-6">
                        ...
                        <div className={`flex items-center gap-2 px-3 py-1.5 rounded-xl text-[9px] font-black uppercase tracking-widest border ${
                          order.order_type === 'delivery' ? 'bg-amber-500/10 text-amber-600 border-amber-500/20' :
