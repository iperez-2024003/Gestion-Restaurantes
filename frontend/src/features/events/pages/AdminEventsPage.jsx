...
import { createEvent, getEvents } from '../../../shared/api/events';
...
export const AdminEventsPage = () => {
  ...
  const handleSubmitEvent = async (formData) => {
    try {
      ...
      // En este caso solo implementamos creación por ahora como estaba antes
      // pero con el nuevo modal interactivo
      await createEvent({
        ...formData,
      ...
      showError('Falla en la publicación del evento');
    } finally {
      setCreating(false);
    }
  };
                ...
                >
                  <div className="h-52 relative overflow-hidden shrink-0">
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex items-end justify-between">
                       ...
                       <span className={`px-4 py-2 rounded-xl text-[9px] font-black uppercase tracking-widest border ${
                         event.status === 'scheduled' ? 'bg-emerald-500/10 text-emerald-400 border-emerald-500/20' : 'bg-zinc-800 text-zinc-500 border-zinc-700'
                       }`}>
                  ...
                  <div className="p-8 flex-1 flex flex-col">
                    ...
                    <div className="flex gap-4">
                       ...
                       <button className="w-14 h-14 bg-rose-500/10 text-rose-500 rounded-2xl flex items-center justify-center border border-rose-500/20 hover:bg-rose-500 hover:text-white transition-all shadow-xl">
