...
export const EventsFeed = () => {
  ...
  return (
    <div className="font-outfit space-y-12 animate-in fade-in duration-700">
      <div className="bg-gradient-to-br from-zinc-900 to-black text-white rounded-[3rem] p-12 shadow-2xl border border-purple-500/10 relative overflow-hidden group">
        <div className="absolute top-0 right-0 p-12 opacity-5">
           <CalendarCheck className="w-32 h-32 text-purple-500" />
        </div>
        <div className="relative z-10">
          <p className="text-[10px] uppercase tracking-[0.4em] font-black text-purple-500 mb-2">Cartelera Exclusiva</p>
          <h1 className="text-5xl font-black tracking-tighter uppercase leading-none">Experiencias <span className="text-zinc-600">Premium</span></h1>
          <p className="mt-6 text-zinc-500 font-bold uppercase tracking-widest text-xs max-w-xl leading-loose">Catas, cenas temáticas y masterclasses diseñadas para los paladares más exigentes de nuestra comunidad.</p>
        </div>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          ...
          {events.map((event, index) => {
            ...
            return (
              <motion.article 
                ...
                className="bg-zinc-900/40 backdrop-blur-3xl rounded-[3rem] border border-purple-500/5 overflow-hidden group hover:border-purple-500/20 transition-all flex flex-col h-full shadow-2xl"
              >
                <div className="h-60 relative overflow-hidden">
                  ...
                  <div className="absolute top-6 left-6">
                     <span className="bg-black/40 backdrop-blur-xl px-4 py-2 rounded-xl text-[9px] font-black text-purple-400 border border-purple-500/20 uppercase tracking-widest">
                ...
                <div className="p-8 flex flex-col flex-1">
                  <h3 className="text-2xl font-black text-white uppercase tracking-tight mb-3 line-clamp-1 group-hover:text-purple-400 transition-colors">{event.name}</h3>
                  <p className="text-xs text-zinc-500 font-bold leading-relaxed mb-8 line-clamp-2">{event.description || 'Una velada inigualable diseñada para sorprender tus sentidos con los mejores ingredientes.'}</p>
                  
                  <div className="space-y-4 mb-10 flex-1">
                    <div className="flex items-center gap-3 text-zinc-400 font-black text-[10px] uppercase tracking-widest bg-black/20 p-3 rounded-2xl border border-zinc-800/50">
                  ...
                  <button
                    ...
                    className={`w-full py-5 rounded-[2rem] font-black uppercase tracking-widest text-[10px] transition-all flex items-center justify-center gap-3 border ${
                      ...
                      : 'bg-zinc-950 text-white border-purple-500/20 hover:bg-purple-600 hover:border-purple-500 shadow-2xl hover:shadow-purple-500/20'
                    }`}
                  >
        ...
        {events.length === 0 && (
          <div className="col-span-full py-32 bg-zinc-900/10 rounded-[4rem] border border-dashed border-zinc-800 text-center">
